...
<section class="py_80">
    <div class="container">
        ...
        <div class="row xl-gx-5 gx-4">
            ...
            <div class="col-lg-7">
                <h1 class="product-title">AC SPD 1 PHASE - 2 POLE</h1>
                <div class="product-sku">BLT-AC-4P</div>

                <p class="product-desc">
                    Protect your three-phase electrical systems with the Blitz Type 2 Surge Protection Device
                    (BLT-AC-4P). Designed for 3-phase AC setups, it delivers dependable protection against lightning
                    strikes and voltage spikes. Its modular DIN-rail mount design, fast response time, and visual fault
                    indicators make it perfect for commercial, industrial, and critical load applications.
                </p>

                <div class="pb_40">
                    <a href="#" class="com_btn" tabindex="-1">
                        Explore MCBs <span class="ms-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="11"
                                viewBox="0 0 24 11" fill="none">
                    ...
                    <li>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <g clip-path="url(#clip0)">
                                <path
                                    d="M1.33398 7.9987C1.33398 11.6781 4.32122 14.6654 8.00065 14.6654C11.6801 14.6654 14.6673 11.6781 14.6673 7.9987C14.6673 4.31926 11.6801 1.33203 8.00065 1.33203C4.32122 1.33203 1.33398 4.31926 1.33398 7.9987V7.9987"
                                    stroke="#666666" stroke-width="1.33333" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path d="M6 8.0013L7.33333 9.33464L10 6.66797" stroke="#666666" stroke-width="1.33333"
                        ...
                        40kA nominal discharge capacity (per phase)
                    </li>
                    <li>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <g clip-path="url(#clip0)">
                        ...
                        ≤1.0kV voltage protection level
                    </li>
                    <li>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <g clip-path="url(#clip0)">
                        ...
                        Supports 230/400V AC three-phase systems
                    </li>
                    <li>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <g clip-path="url(#clip0)">
                        ...
                        Quick installation with 35mm DIN rail
                    </li>
                </ul>
        ...
        <div class="table-wrapper">
            ...
            <table class="table-light">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Mounting Type</td>
                        <td>35mm DIN Rail (IEC 60715)</td>
                    </tr>
                    <tr>
                        <td>Module Width</td>
                        <td>4 Modules (72mm)</td>
                    </tr>
                    <tr>
                        <td>Wire Cross Section</td>
                        <td>2.5~35mm&sup2; (Rigid/Flexible)</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Visual Fault Window (Green/Red)</td>
                    </tr>
                </tbody>
            </table>
