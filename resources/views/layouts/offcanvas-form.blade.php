<div class="offcanvas offcanvas-end" tabindex="-1" id="inquiryOffcanvas" aria-labelledby="inquiryOffcanvasLabel"
    ...
    <div class="offcanvas-body">
        <div class="quote-section">
            ...
            <div class="quote-form-wrapper">
                <form class="quote-form" id="contact-form-offcanvas" action="{{ route('contact.submit') }}"
                    method="POST">
                    @csrf
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select name="country" id="country-offcanvas">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="city" id="city-offcanvas" placeholder="Ahmedabad"
                                value="{{ old('city') }}"
                                oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '').replace(/\s{2,}/g, ' ').trimStart();">
                            @error('city')
                                <span class="text-danger">{{ $message }}</span>
                    ...
                    <button type="submit" class="com_btn w-100 justify-content-center" id="contactSubmitBtnOffcanvas">
                        Get Quote
                        <svg class="ms-2" width="18" height="18" viewBox="0 0 18 18" fill="none"
