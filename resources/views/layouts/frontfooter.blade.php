           ...
           <div class="footer-top">
               ...
               <div class="footer-brand">
                   ...
                   <div class="socials">
                       ...
                       <a href="https://www.instagram.com/blitz_energy_india"  target="_blanck"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                               xmlns="http://www.w3.org/2000/svg">
  ...
  <defs>
    ...
    <linearGradient id="skyGrad" x1="0%" y1="0%" x2="0%" y2="100%">
      <stop offset="0%" stop-color="#02030A">
        <animate attributeName="stop-color" values="#02030A;#090A24;#02030A" dur="20s" repeatCount="indefinite" />
      </stop>
      <stop offset="100%" stop-color="#12143B">
        <animate attributeName="stop-color" values="#12143B;#181A4A;#12143B" dur="20s" repeatCount="indefinite" />
      </stop>
    </linearGradient>
  ...
  <style>
    ...
    .star { fill: #ffffff; animation: gentleTwinkle 4s infinite ease-in-out; transform-origin: center; transform-box: fill-box; }
    .star:nth-child(1) { animation-duration: 6s; animation-delay: 0.5s; }
    .star:nth-child(2) { animation-duration: 4.5s; animation-delay: 2s; }
    .star:nth-child(3) { animation-duration: 7s; animation-delay: 1s; }
    .star:nth-child(4) { animation-duration: 5.5s; animation-delay: 3s; }
    .star:nth-child(5) { animation-duration: 8s; animation-delay: 0s; }
    .star:nth-child(even) { animation-direction: alternate-reverse; }

    @keyframes gentleTwinkle {
      0%, 100% { opacity: 0.15; transform: scale(0.8); }
      50% { opacity: 0.9; transform: scale(1.2); filter: drop-shadow(0px 0px 4px rgba(255,255,255,0.8)); }
    }

    /* 2. Fast Shooting Stars */
    .shooting-star { stroke-dasharray: 300; stroke-dashoffset: 300; animation: shootStar 15s infinite ease-out; opacity: 0; }
    .shooting-star-2 { stroke-dasharray: 200; stroke-dashoffset: 200; animation: shootStar 22s infinite ease-out 8s; opacity: 0; }
    @keyframes shootStar {
      0% { transform: translate(1600px, -50px) rotate(-30deg); stroke-dashoffset: 300; opacity: 1; }
      15% { transform: translate(600px, 500px) rotate(-30deg); stroke-dashoffset: 0; opacity: 0; }
      100% { transform: translate(600px, 500px) rotate(-30deg); opacity: 0; }
    }

    /* 3. High Altitude Airplane */
    .airplane-path { animation: planeFly 40s infinite linear 5s; }
    .strobe-red { fill: #ff3333; animation: strobeBlink 1.2s infinite; }
    .strobe-white { fill: #ffffff; animation: strobeBlink 0.8s infinite 0.4s; }
    
    @keyframes planeFly {
      0% { transform: translate(-100px, 150px) scale(0.8); }
      100% { transform: translate(2100px, 50px) scale(0.8); }
    }
    @keyframes strobeBlink {
      0%, 48%, 52%, 100% { opacity: 0; filter: none; }
      50% { opacity: 1; filter: drop-shadow(0 0 4px currentColor); }
    }

    /* 4. Helicopter Search Animation */
    .heli-container { animation: heliFlight 35s infinite ease-in-out; }
    .heli-rotor { animation: rotorSpin 0.1s infinite linear; }
    .search-beam { transform-origin: 0px 5px; animation: beamSweep 6s infinite ease-in-out; }

    @keyframes heliFlight {
      0% { transform: translate(2100px, 120px) rotate(5deg); }
      20% { transform: translate(1300px, 160px) rotate(-2deg); } /* Arrive & Hover */
      30% { transform: translate(1280px, 165px) rotate(2deg); } /* Slight drift */
      45% { transform: translate(800px, 140px) rotate(-5deg); } /* Move to new spot */
      55% { transform: translate(780px, 145px) rotate(1deg); } /* Hover again */
      75% { transform: translate(-200px, 90px) rotate(-8deg); } /* Fly away */
      100% { transform: translate(-200px, 90px); }
    }
    @keyframes rotorSpin {
      0% { opacity: 0.8; transform: scaleX(1); }
      50% { opacity: 0.3; transform: scaleX(0.1); }
      100% { opacity: 0.8; transform: scaleX(1); }
    }
    @keyframes beamSweep {
      0% { transform: rotate(-35deg); opacity: 0.9; }
      50% { transform: rotate(35deg); opacity: 0.5; }
      100% { transform: rotate(-35deg); opacity: 0.9; }
    }

    /* 5. Moon & Environment */
    .moon { animation: moonPulse 6s infinite alternate ease-in-out; transform-origin: center; }
    @keyframes moonPulse {
      0% { filter: drop-shadow(0px 0px 15px rgba(255, 251, 234, 0.4)); }
      100% { filter: drop-shadow(0px 0px 35px rgba(255, 251, 234, 0.9)); }
    }
    .horizon-glow { animation: ambientGlow 12s infinite alternate ease-in-out; }
    @keyframes ambientGlow { 0% { opacity: 0.6; } 100% { opacity: 1; } }
    .cloud-back { fill: #ffffff; opacity: 0.04; animation: drift 100s infinite linear; }
    @keyframes drift { 0% { transform: translateX(-400px); } 100% { transform: translateX(2100px); } }

    /* 6. Window Groups */
    .win-off { fill: #202256; }
    .win-sync-a { fill: #FFCC00; animation: syncA 7s infinite; }
    @keyframes syncA {
      0%, 85% { opacity: 0.1; } 
      86%, 88% { opacity: 1; filter: drop-shadow(0 0 6px rgba(255,204,0,0.8)); } 
      89%, 91% { opacity: 0.3; } 
      92%, 96% { opacity: 1; filter: drop-shadow(0 0 8px rgba(255,204,0,1)); } 
      97%, 100% { opacity: 0.1; }
    }
    .win-sync-b { fill: #FFCC00; animation: syncB 11s infinite; }
    @keyframes syncB {
      0%, 40% { opacity: 0.1; }
      41%, 43% { opacity: 1; filter: drop-shadow(0 0 6px rgba(255,204,0,0.8)); }
      44%, 45% { opacity: 0.1; }
      46%, 49% { opacity: 1; filter: drop-shadow(0 0 6px rgba(255,204,0,0.8)); }
      50%, 100% { opacity: 0.1; }
    }
    .win-spark-1 { fill: #FFCC00; animation: spark1 15s infinite; }
    @keyframes spark1 {
      0%, 70% { opacity: 0.1; }
      71%, 78% { opacity: 1; filter: drop-shadow(0 0 4px rgba(255,204,0,0.6)); }
      79%, 100% { opacity: 0.1; }
    }
    .win-spark-2 { fill: #FFCC00; animation: spark2 9s infinite 2s; }
    @keyframes spark2 {
      0%, 10% { opacity: 0.1; }
      11%, 13% { opacity: 1; filter: drop-shadow(0 0 8px rgba(255,204,0,0.9)); }
      14%, 100% { opacity: 0.1; }
    }
  </style>
  ...
  <line x1="0" y1="0" x2="200" y2="0" stroke="url(#trailGrad)" stroke-width="2.5" stroke-linecap="round" class="shooting-star" />
  <line x1="0" y1="0" x2="120" y2="0" stroke="url(#trailGrad)" stroke-width="1.5" stroke-linecap="round" class="shooting-star-2" style="transform: translate(1200px, -20px) rotate(-25deg);" />
  ...
  <g class="heli-container">
    <g transform="scale(0.8)">
      ...
      <ellipse cx="35" cy="-2" rx="1.5" ry="5" fill="#ffffff" class="heli-rotor"/>
      <path d="M-12,2 C-12,-4 -5,-8 3,-8 C12,-8 18,-4 18,2 C18,7 10,8 3,8 C-5,8 -12,7 -12,2 Z" fill="#0A0C27"/>
      <path d="M-12,2 C-12,-2 -5,-6 0,-6 L0,2 Z" fill="#D2E3FF" opacity="0.6"/>
      <ellipse cx="3" cy="-10" rx="22" ry="1.5" fill="#ffffff" class="heli-rotor"/>
   ...
   <button class="sticky-inquiry-btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#inquiryOffcanvas" aria-controls="inquiryOffcanvas">Inquiry Now</button>
