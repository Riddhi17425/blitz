        ...
        <div class="container-xxl">
            ...
            <div class="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
                <div class="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center zindex-popover">
                    ...
                    <a class="nav-link dropdown-toggle pulse p-0" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" data-bs-display="static">
                    ...
                    {{-- <div class="setting ms-2">
                        <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#Settingmodal"><i class="icofont-gear-alt fs-5"></i></a>
                    </div> --}}
            </div>
