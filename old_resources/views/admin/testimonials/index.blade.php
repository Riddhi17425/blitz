...
@section('content')
        ...
        <div class="container-xxl">
                ...
                <div class="border-0 mb-4">
                    <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                        ...
                        <div class="col-auto d-flex w-sm-100">
                            <a href="{{ route('testimonials.addtestimonials') }}">
            ...
            <div class="row clearfix g-3">
                <div class="col-sm-12">
                    <div class="card mb-3">
                        <div class="card-body">
                            <table id="testimonials_table" class="table table-hover align-middle mb-0" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Title</th>
    ...
    <script>
        window.APP_URLS = {
            gettestimonialsdata: "{{ route('gettestimonialsData') }}",
            deletetestimonials:"{{ route('testimonials.delete' , [':id']) }}",
            csrfToken: "{{ csrf_token() }}",
            image_path: "{{ asset('public/admin/testimonials/') }}"
        };
    </script>
