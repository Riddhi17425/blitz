      ...
      <div class="container">
         <div class="banner_grid">
            <div class="baner_left">
               ...
               <h1 class="banner_title">{{$category->title ?? ''}}</h1>
            ...
            <a href="{{ asset('public/international_catalogue.pdf') }}" target="_blank" class="com_btn">
               <span class="me-2">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                     ...
                     <path d="M7 10L12 15L17 10" stroke="white" stroke-width="1.33333" stroke-linecap="round"
                        stroke-linejoin="round" />
                     <path d="M12 15V3" stroke="white" stroke-width="1.33333" stroke-linecap="round"
                        stroke-linejoin="round" />
                  </svg>
               </span>
               Download Catalogue
